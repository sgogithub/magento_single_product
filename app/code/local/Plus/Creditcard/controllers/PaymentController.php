...
class Plus_Creditcard_PaymentController extends Mage_Core_Controller_Front_Action {
    ...
    public function redirectAction() {
        ...
        $urlJs = Mage::getStoreConfig('payment/creditcard/environment') == 'production' ? 'https://kit.espay.id' : 'https://sandbox-kit.espay.id';
        $key = Mage::getStoreConfig('payment/creditcard/paymentid');
        ...
        $this->loadLayout();
        $block = $this->getLayout()->createBlock('Mage_Core_Block_Template', 'creditcard', array('template' => 'creditcard/redirect.phtml'));
    ...
    public function pendingAction() {
        ...
        $this->loadLayout();
        $block = $this->getLayout()->createBlock('Mage_Core_Block_Template', 'creditcard', array('template' => 'creditcard/pending.phtml'));
    ...
    public function responseAction() {
        ...
        if ($this->getRequest()->get("id")) {
            if ($this->getRequest()->get("id") !== '') {
                ...
                $orderData = $order->getData();
                $defaultPaymentStatus = Mage::getStoreConfig('payment/creditcard/accepted_payment_status');
