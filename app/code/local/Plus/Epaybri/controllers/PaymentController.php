...
class Plus_Epaybri_PaymentController extends Mage_Core_Controller_Front_Action {
    ...
    public function redirectAction() {
        ...
        $urlJs = Mage::getStoreConfig('payment/epaybri/environment') == 'production' ? 'https://kit.espay.id' : 'https://sandbox-kit.espay.id';
        $key = Mage::getStoreConfig('payment/epaybri/paymentid');
        ...
        $this->loadLayout();
        $block = $this->getLayout()->createBlock('Mage_Core_Block_Template', 'epaybri', array('template' => 'epaybri/redirect.phtml'));
    ...
    public function pendingAction() {
        ...
        $this->loadLayout();
        $block = $this->getLayout()->createBlock('Mage_Core_Block_Template', 'epaybri', array('template' => 'epaybri/pending.phtml'));
    ...
    public function responseAction() {
        ...
        if ($this->getRequest()->get("id")) {
            if ($this->getRequest()->get("id") !== '') {
                ...
                $orderData = $order->getData();
                $defaultPaymentStatus = Mage::getStoreConfig('payment/epaybri/accepted_payment_status');
